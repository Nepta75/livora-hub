...
import { Users, Building2, Shield, LayoutDashboard, LogOut } from 'lucide-react';
...
export function Sidebar() {
  ...
  // Before mount: render all items so server and client HTML match.
  // After mount: apply admin filter.
